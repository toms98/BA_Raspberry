...
def curser_one_callback(*x):
    print("x=", x)


def curser_two_callback(*x):
    print("x=", x)


def trigger_scroll_callback(*x):
    print("x=", x)
    global trigger_scrollbar
    print(trigger_scrollbar.get())
...
# Scrollbar
trigger_scrollbar = Scrollbar(fenster, command=do_nothing, width=25, orient=VERTICAL)
cursor1_scrollbar = Scrollbar(fenster, command=do_nothing, width=25, orient=HORIZONTAL)
cursor2_scrollbar = Scrollbar(fenster, command=do_nothing, width=25, orient=HORIZONTAL)
