...
def makeFig():
    ...
    ax.plot(data_rx_x, data_rx_y, 'g')
    ax.axhline(y=trigger, color='r')
    ax.set_xlim(-scaler_x, scaler_x)
    ax.set_ylim(-scaler_y, scaler_y)
